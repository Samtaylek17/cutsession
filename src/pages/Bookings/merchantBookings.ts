...
class MerchantBookings extends AbstractView {
	...
	scripts() {
		...
		form.addEventListener('submit', (event) => {
			...
			const merchant = JSON.parse(localStorage.getItem('user') as string);
			...
			let data: { city: string; merchant: string; period?: string } = { city, merchant: merchant.token };
